  ...
  <div class="flex justify-center align-center bg-sky-500 h-screen">
    <div class="bg-white m-5 w-full md:w-80 rounded-xl">
        ...
        <div class="p-4">
            ...
            <div class="p-2">
                <input type="text" name="todo" id="todo" value="{{ $todo->todo ?? '' }}" placeholder="Create project..." class="bg-gray-300 w-full p-2 rounded-lg" required>
            </div>
            </form>
        </div>
        <div class="p-4">
            ...
            @foreach ($todos as $item)
                <div class="flex justify-between">
                    <div class="bg-blue-600 p-2 text-white rounded-lg m-2 w-full">
                        {{ $item->todo }}
                    </div>
                    <div class="flex">
                        <a href="{{ route('edit', ['id' => $item->id]) }}" class="bg-amber-500 p-2 text-white rounded-lg m-2">
